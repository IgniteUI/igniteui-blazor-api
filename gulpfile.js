...
function copyBlazorSource(callback) {
    ...
    gulp.src([
        './app/bin/Debug/net8.0/IgniteUI.Blazor*.*'
     // './app/bin/Debug/net8.0/IgniteUI.Blazor.dll',
     // './app/bin/Debug/net8.0/IgniteUI.Blazor.Documents.Core.dll',
     // './app/bin/Debug/net8.0/IgniteUI.Blazor.Documents.Excel.dll',
    ])
